...
# ELegimos el color de las celdas
bg = 25, 25, 25
    ...
    for y in range(0, nxC):
        for x in range(0, nyC):
            ...
            if not pauseExect: 
                ...
                #Regla 1: Una celula muerta con exactamente tres vecinas vivas, "revive"
                if gameState[x,y] == 0 and n_neigh == 3:
                    newGameState[x,y] = 1
                #Regla 2: Una celula viva con menos de dos o mas de tres vecinas vivas, "muere"
